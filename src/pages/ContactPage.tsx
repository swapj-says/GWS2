...
function ContactPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    window.location.href = `mailto:gwsmarketings@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    setSent(true);
  };
      ...
      <section className="container-page py-12 grid lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <a href="mailto:hello@gwsmarketing.com" className="block rounded-3xl border border-border bg-background p-6 hover:bg-foreground hover:text-background transition-colors group">
            ...
            <p className="font-semibold">gwsmarketings@gmail.com</p>
          </a>
          <a href="https://wa.me/918421888476" target="_blank" rel="noreferrer" className="block rounded-3xl border border-border bg-background p-6 hover:bg-foreground hover:text-background transition-colors group">
          ...
          <a href="https://www.instagram.com/gws_marketings?igsh=NXJ4ZG00MnRobmY0" target="_blank" rel="noreferrer" className="block rounded-3xl border border-border bg-background p-6 hover:bg-foreground hover:text-background transition-colors group">
