...
function HomePage() {
  ...
  useEffect(() => {
    ...
    supabase.from("projects").select("id,title,category,image_url,link").eq("featured", true).order("sort_order").limit(4).then(({ data }) => setProjects(data ?? []));
  }, []);
        ...
        <div className="container-page relative pt-12 md:pt-20 pb-0">
          ...
          <div className="relative mt-8 max-w-xl mx-auto z-10">
            ...
            <img
              ...
              style={{ filter: "drop-shadow(0 24px 48px rgb(0 0 0 / 0.15))" }}
            />
          </div>

          {/* Hero text below image */}
          <div className="text-center max-w-4xl mx-auto relative z-0 pb-20 -mt-4">
